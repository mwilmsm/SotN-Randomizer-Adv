...
export const safe = presets.filter(function (preset) {
...
const items = cloneItems(window.sotnRando.items)
...
export function resetTarget(showFileName) {
  if (selectedFile) {
...
export function outputChange(event) {
...
export function presetChange(event) {
...
export function presetIdChange() {
...
export function adjustMaxComplexity() {
...
export function relicLocationsExtensionChange() {
  let value
...
export function appendSeedChange() {
  localStorage.setItem('appendSeed', elems.appendSeed.checked)
}

export function fileChange(event) {
...
export function tournamentModeChange() {
...
export function showRelicsChange() {
...
export function showSolutionsChange() {
  showSpoilers()
  localStorage.setItem('showSolutions', elems.showSolutions.checked)
}

export function dragLeaveListener(event) {
  elems.target.classList.remove('active')
}
...
export function randomizedFilename(filename, seed) {
...
export function getFormRelicLocations() {
...
export function clearHandler(event) {
...
export function copyHandler(event) {
  event.preventDefault()
  event.stopPropagation()
...
export function showOlderHandler(event) {
  elems.showOlder.classList.add('hidden')
  elems.older.classList.remove('hidden')
}

export function loadOption(name, changeHandler, defaultValue) {
